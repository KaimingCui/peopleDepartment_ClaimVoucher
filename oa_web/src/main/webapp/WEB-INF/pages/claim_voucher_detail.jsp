            ...
            <div class="panel heading-border">
                <div class="panel-body bg-light">
                    ...
                    <div class="section row">
                        ...
                        <div class="col-md-4"><spring:eval expression="claimVoucher.createTime"></spring:eval></div>
                    </div>
                    <div class="section row">
                    ...
                    <div class="section row">
                        ...
                        <div class="col-md-3"><spring:eval expression="record.dealTime"></spring:eval></div>
